...
while True:
    ...
    py = """
    Python is a high level programming language which was developed by Guido Van Rossum and released in 1991. Python is a dynamic, high level, free open source and interpreted programming language. It also supports multiple inheritance, unlike Java.
"""
